...
export type CreateCustomerCustomFieldsInput = {
  CNI?: InputMaybe<Scalars['String']['input']>;
};
...
export type CreateTransactionEntryInput = {
  ...
  code: Scalars['String']['input'];
  typeEntry: Scalars['String']['input'];
  customFields?: InputMaybe<Scalars['JSON']['input']>;
  description: Scalars['String']['input'];
  localizedName: Scalars['String']['input'];
  translations: Array<TransactionEntryTranslationInput>;
};
...
export type CustomFields = {
  ...
  TransactionEntry: Array<CustomFieldConfig>;
...
export type CustomerCustomFields = {
  ...
  CNI?: Maybe<Scalars['String']['output']>;
};

export type CustomerFilterParameter = {
  CNI?: InputMaybe<StringOperators>;
...
export type Mutation = {
  ...
  deleteTransactionEntry: DeletionResponse;
  /** Delete a Zone */
  ...
  updateTransactionEntry: TransactionEntry;
...
export type MutationCreateTransactionEntryArgs = {
...
export type MutationDeleteTransactionEntryArgs = {
  id: Scalars['ID']['input'];
};
...
export type MutationUpdateTransactionEntryArgs = {
...
export type Query = {
  ...
  transactionEntries: TransactionEntryList;
  transactionEntry?: Maybe<TransactionEntry>;
  zone?: Maybe<Zone>;
  zones: ZoneList;
};
...
export type QueryTransactionEntriesArgs = {
  options?: InputMaybe<TransactionEntryListOptions>;
};


export type QueryTransactionEntryArgs = {
  id: Scalars['ID']['input'];
};
...
export type TransactionEntry = Node & {
  __typename?: 'TransactionEntry';
  ...
  translations: Array<TransactionEntryTranslation>;
  typeEntry: Scalars['String']['output'];
  updatedAt: Scalars['DateTime']['output'];
  dateTransaction: Scalars['DateTime']['output'];

};

export type TransactionEntryFilterParameter = {
  _and?: InputMaybe<Array<TransactionEntryFilterParameter>>;
  _or?: InputMaybe<Array<TransactionEntryFilterParameter>>;
  ...
  typeEntry?: InputMaybe<StringOperators>;
  updatedAt?: InputMaybe<DateOperators>;
};

export type TransactionEntryList = PaginatedList & {
  __typename?: 'TransactionEntryList';
  items: Array<TransactionEntry>;
  totalItems: Scalars['Int']['output'];
};

export type TransactionEntryListOptions = {
  /** Allows the results to be filtered */
  filter?: InputMaybe<TransactionEntryFilterParameter>;
  /** Specifies whether multiple top-level "filter" fields should be combined with a logical AND or OR operation. Defaults to AND. */
  filterOperator?: InputMaybe<LogicalOperator>;
  /** Skips the first n results, for use in pagination */
  skip?: InputMaybe<Scalars['Int']['input']>;
  /** Specifies which properties to sort the results by */
  sort?: InputMaybe<TransactionEntrySortParameter>;
  /** Takes n results, for use in pagination */
  take?: InputMaybe<Scalars['Int']['input']>;
};

export type TransactionEntrySortParameter = {
  ...
  typeEntry?: InputMaybe<SortOrder>;
  updatedAt?: InputMaybe<SortOrder>;
  dateTransaction?: InputMaybe<SortOrder>;
};

export type TransactionEntryTranslation = {
  __typename?: 'TransactionEntryTranslation';
  createdAt: Scalars['DateTime']['output'];
  id: Scalars['ID']['output'];
  languageCode: LanguageCode;
  localizedName: Scalars['String']['output'];
...
export type TransactionEntryTranslationInput = {
  customFields?: InputMaybe<Scalars['JSON']['input']>;
  id?: InputMaybe<Scalars['ID']['input']>;
  languageCode: LanguageCode;
...
export type UpdateTransactionEntryInput = {
  ...
  id: Scalars['ID']['input'];
  localizedName?: InputMaybe<Scalars['String']['input']>;
  translations?: InputMaybe<Array<TransactionEntryTranslationInput>>;
};
...
export type OrderDetailQueryDetailsQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type OrderDetailQueryDetailsQuery = { __typename?: 'Query', order?: { __typename: 'Order', id: string, lines: Array<{ __typename: 'OrderLine', id: string, quantity: number }> } | null };

export type OrderLineFragment = { __typename: 'OrderLine', id: string, quantity: number };

export type OrderDetailFragment = { __typename: 'Order', id: string, lines: Array<{ __typename: 'OrderLine', id: string, quantity: number }> };
...
export type TransitionFulfillmentToStateMutation = { __typename?: 'Mutation', transitionFulfillmentToState: { __typename?: 'Fulfillment', id: string, state: string, nextStates: Array<string>, createdAt: any, updatedAt: any, method: string, trackingCode?: string | null, lines: Array<{ __typename?: 'FulfillmentLine', orderLineId: string, quantity: number }> } | { __typename?: 'FulfillmentStateTransitionError', errorCode: ErrorCode, message: string, transitionError: string } };

export type GetTransactionEntriesQueryVariables = Exact<{
  options?: InputMaybe<TransactionEntryListOptions>;
}>;


export type GetTransactionEntriesQuery = { __typename?: 'Query', transactionEntries: { __typename?: 'TransactionEntryList', totalItems: number, items: Array<{ __typename?: 'TransactionEntry', id: string, code: string, typeEntry: string, amount: number, description: string, createdAt: any, updatedAt: any }> } };

export type TransactionEntryDetailFragment = { __typename?: 'TransactionEntry', id: string, code: string, amount: number, description: string, typeEntry: string, createdAt: any, updatedAt: any };

export type GetTransactionEntryDetailQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type GetTransactionEntryDetailQuery = { __typename?: 'Query', transactionEntry?: { __typename?: 'TransactionEntry', id: string, code: string, amount: number, description: string, typeEntry: string, createdAt: any, updatedAt: any } | null };

export type CreateTransactionEntryMutationVariables = Exact<{
  input: CreateTransactionEntryInput;
}>;


export type CreateTransactionEntryMutation = { __typename?: 'Mutation', createTransactionEntry: { __typename?: 'TransactionEntry', id: string, code: string, amount: number, description: string, typeEntry: string, createdAt: any, updatedAt: any } };

export type UpdateTransactionEntryMutationVariables = Exact<{
  input: UpdateTransactionEntryInput;
}>;

export type ProductVariantFieldsFragment = { __typename: 'ProductVariant', id: string, sku: string, name: string, enabled: boolean, price: any, priceWithTax: any, currencyCode: CurrencyCode, trackInventory: GlobalFlag, stockOnHand: number, stockAllocated: number, outOfStockThreshold: number, stockLevel: string, useGlobalOutOfStockThreshold: boolean, createdAt: any, updatedAt: any, facetValues: Array<{ __typename?: 'FacetValue', id: string, name: string }>, options: Array<{ __typename?: 'ProductOption', id: string, code: string, name: string }>, featuredAsset?: { __typename?: 'Asset', preview: string } | undefined, assets: Array<{ __typename?: 'Asset', id: string, preview: string, focalPoint?: { __typename?: 'Coordinate', x: number, y: number } | undefined }>, product: { __typename?: 'Product', id: string, name: string, slug: string, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | undefined } };
...
export const TransactionEntryDetailFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"TransactionEntryDetail"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"TransactionEntry"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"amount"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"typeEntry"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<TransactionEntryDetailFragment, unknown>;
export const OrderDetailQueryDetailsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"OrderDetailQueryDetails"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"order"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OrderDetail"}},{"kind":"Field","name":{"kind":"Name","value":"__typename"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OrderLine"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OrderLine"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"quantity"}},{"kind":"Field","name":{"kind":"Name","value":"__typename"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OrderDetail"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Order"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"lines"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OrderLine"}}]}},{"kind":"Field","name":{"kind":"Name","value":"__typename"}}]}}]} as unknown as DocumentNode<OrderDetailQueryDetailsQuery, OrderDetailQueryDetailsQueryVariables>;
...
// export const GetTransactionEntriesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetTransactionEntries"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"options"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"TransactionEntryListOptions"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"transactionEntries"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"options"},"value":{"kind":"Variable","name":{"kind":"Name","value":"options"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"typeEntry"}},{"kind":"Field","name":{"kind":"Name","value":"amount"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"totalItems"}}]}}]}}]} as unknown as DocumentNode<GetTransactionEntriesQuery, GetTransactionEntriesQueryVariables>;
// export const GetTransactionEntryDetailDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetTransactionEntryDetail"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"transactionEntry"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"TransactionEntryDetail"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"TransactionEntryDetail"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"TransactionEntry"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"amount"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"typeEntry"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<GetTransactionEntryDetailQuery, GetTransactionEntryDetailQueryVariables>;
// export const CreateTransactionEntryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateTransactionEntry"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateTransactionEntryInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createTransactionEntry"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"TransactionEntryDetail"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"TransactionEntryDetail"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"TransactionEntry"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"amount"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"typeEntry"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<CreateTransactionEntryMutation, CreateTransactionEntryMutationVariables>;
// export const UpdateTransactionEntryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateTransactionEntry"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateTransactionEntryInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateTransactionEntry"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"TransactionEntryDetail"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"TransactionEntryDetail"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"TransactionEntry"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"amount"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"typeEntry"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<UpdateTransactionEntryMutation, UpdateTransactionEntryMutationVariables>;
